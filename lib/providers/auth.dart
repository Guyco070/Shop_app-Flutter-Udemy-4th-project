...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url = Uri.parse(
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyADjKoOHmx50i-3OeBsyLWznmX3GOO1CVk');
    try {
  ...
  Future<bool> tryAutoLogin() async {
    ...
    final extractedUserData = jsonDecode(pref.getString('userData')!);
    final expiryDate =
